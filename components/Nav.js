  ...
  return (
    ...
    >
      <div
       ...
       xl:justify-center gap-y-3 px-4 md:px-40 xl:px-0 h-[80px] xl:h-max py-8
        ...
        {navData.map((link, index) => {
          return (
            <Link
              ...
              } relative flex items-center group hover:text-accent transition-all duration-300 text-2xl`}
              key={index}
              href={link.path}
            >
              {/* tooltip */}
